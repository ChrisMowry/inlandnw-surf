...
set STATE_FILE_DEF=states_def.json
set STATE_DATA_FILE=states.json
set ENDPOINT_URL=http://localhost:8000


aws dynamodb delete-table --table-name states --endpoint-url %ENDPOINT_URL%
...
aws dynamodb scan --table-name states --endpoint-url %ENDPOINT_URL%